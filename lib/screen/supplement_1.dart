...
_imageFromCamera () async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       ...
       appBar : AppBar(title: Text('Add Supplement'),),
      body:  SingleChildScrollView(
        padding: EdgeInsets.all(20),
        child: Form(child: Column(children: [
          Container(alignment: Alignment.center,
          child: Text('Add Supplement Details', style: TextStyle(
            fontSize: 20,
          ...
          Stack(children: [
            ...
            ?const AssetImage('images/profile_image.png') as ImageProvider : FileImage(_image!),
...
maxLength: 30,
decoration:  InputDecoration(labelText: 'Supplement Rate',
...
maxLength: 30,
decoration:  InputDecoration(labelText: 'Supplement Type',
    ...
    ElevatedButton(
      ...
      onPressed: (){
        ...
        Supplement supplement = Supplement(
          ...
          httpSupplement().registerSupplement(supplement,_image);
 ...
 Widget bottomSheet(){
    return Container(child: Column(children: [
     ...
     Row(
       ...
       children: [
         ElevatedButton.icon(onPressed: (){}, icon: Icon(Icons.image), label: Text('Camera')),
         ElevatedButton.icon(onPressed: (){}, icon: Icon(Icons.image), label: Text('Gallery'))
       ],
     )
